(function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", button_class_value = "" + (/*width*/ ctx[0] + " " + /*use*/ ctx[1] + " svelte-1nqh6iy"));
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*width, use*/ 3 && button_class_value !== (button_class_value = "" + (/*width*/ ctx[0] + " " + /*use*/ ctx[1] + " svelte-1nqh6iy"))) {
    ...
    function add_css$1(target) {
    	append_styles(target, "svelte-13we4wh", "div.svelte-13we4wh{grid-column-start:1;grid-column-end:5;background-color:#444;color:white;font-weight:100;text-align:right;align-self:end;padding:15px 16px 0 0}");
    }
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const toDispString = val => {
    		...
    		$$invalidate(0, fontSize = digits.length > 8 ? "2.1em" : "3.2em");
    		return dispString;
    	};
    ...
    function add_css(target) {
    	append_styles(target, "svelte-18bvv2m", "@import url('https://fonts.googleapis.com/css2?family=Work+Sans:wght@200&display=swap');.calc.svelte-18bvv2m{font-size:var(--fontSize);display:inline-grid;justify-content:center;grid-template-columns:repeat(3, 3.875em) 4.06em;grid-template-rows:4.875em repeat(5, 3.125em);margin:0 auto;gap:1px;background:#444;font-family:'Work Sans', sans-serif}");
    }

    // (28:1) <Calcbtn use="fn" on:func = {setOperColor} >
    ...
    // (31:1) <Calcbtn use="oper" on:func = {setOperColor}>
    ...
    // (35:1) <Calcbtn use="oper" on:func = {setOperColor}>
    ...
    // (39:1) <Calcbtn use="oper" on:func = {setOperColor}>
    ...
    // (43:1) <Calcbtn use="oper" on:func = {setOperColor}>
    ...
    // (46:1) <Calcbtn use="oper" on:func = {setOperColor}>
    ...
    function create_fragment(ctx) {
    	...
    	calcbtn0.$on("func", /*setOperColor*/ ctx[2]);
    	...
    	calcbtn3.$on("func", /*setOperColor*/ ctx[2]);
    	...
    	calcbtn7.$on("func", /*setOperColor*/ ctx[2]);
    	...
    	calcbtn10.$on("ac", /*setClear*/ ctx[3]);
    	...
    	calcbtn11.$on("func", /*setOperColor*/ ctx[2]);
    	...
    	calcbtn12.$on("ac", /*setClear*/ ctx[3]);
    	...
    	calcbtn13.$on("ac", /*setClear*/ ctx[3]);
    	...
    	calcbtn14.$on("ac", /*setClear*/ ctx[3]);
    	...
    	calcbtn15.$on("func", /*setOperColor*/ ctx[2]);
    	...
    	calcbtn17.$on("ac", /*setClear*/ ctx[3]);
    	...
    	calcbtn18.$on("func", /*setOperColor*/ ctx[2]);
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", "calc svelte-18bvv2m");
    			set_style(div, "--fontSize", /*calcFontSize*/ ctx[0]);
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    		...
    		p(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*calcFontSize*/ 1) {
    				set_style(div, "--fontSize", /*calcFontSize*/ ctx[0]);
    			}
    		},
    		i(local) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ('calcFontSize' in $$props) $$invalidate(0, calcFontSize = $$props.calcFontSize);
    	};

    	return [calcFontSize, calc, setOperColor, setClear, div_binding];
    }

    class Calculator extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment, safe_not_equal, { calcFontSize: 0 }, add_css);
    	}
    }
